...
$(LUA_CLIB_PATH)/lproto.so : lualib-src/lproto/lproto.c lualib-src/lproto/proto.c lualib-src/lproto/ldef.c | $(LUA_CLIB_PATH)
	$(CC) $(CFLAGS) $(SHARED) -Ilualib-src/lproto $^ -o $@ 
